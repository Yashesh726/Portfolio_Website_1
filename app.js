...
// remove active class from and icon on click link
...
// toggle theme and store selction within local storage
...
const toggleTheme=()=>
{
    bodyElement.classList.toogle('dark-theme');
...
// Scroll Reveal
const sr=ScrollReveal({distance:'50px',duration:1500,easing:'cubic-bezier(0.68,-0.55,0.265,1.55)'});
